...
CURRICULUM = {
    "football": [
        ...
        ("f9", "Documentación del partido", [5], False, [
            "Qué documentos existen y quién los pide",
            "Antes del partido: listas, identidad y dorsales",
            "La planilla: qué campos tiene y cómo se completa",
            "Registrar goles, cambios y tiempos durante el partido",
            "Amonestaciones y expulsiones en la planilla",
            "Firmas: quién firma, cuándo y qué hacer si se niegan",
            "El informe arbitral: hechos, no opiniones",
            "El informe ampliatorio por expulsión o incidente grave",
            "Plazos y entrega a la organización",
            "Errores administrativos frecuentes y cómo evitarlos",
        ]),
    ],
    "futsal": [
        ...
        ("s11", "Documentación del partido", [5], False, [
            "Qué documentos existen y quién los pide",
            "Antes del partido: listas, identidad y dorsales",
            "La planilla de futsal: qué la diferencia",
            "Registrar las faltas acumuladas por período",
            "Registrar tiempos muertos, goles y cambios",
            "Amonestaciones, expulsiones y el reemplazo tras la expulsión",
            "Firmas: quién firma, cuándo y qué hacer si se niegan",
            "El informe arbitral: hechos, no opiniones",
            "El informe ampliatorio por expulsión o incidente grave",
    ...
    "beach_soccer": [
        ...
        ("p11", "Documentación del partido", [5], False, [
            "Qué documentos existen y quién los pide",
            "Antes del partido: listas, identidad y dorsales",
            "La planilla de fútbol playa: qué la diferencia",
            "Registrar los tres períodos y el resultado",
            "Registrar goles, cambios y paradas médicas",
            "Amonestaciones y expulsiones en la planilla",
            "Anotar prórroga, penales y el reparto de puntos",
            "Firmas: quién firma, cuándo y qué hacer si se niegan",
            "El informe arbitral: hechos, no opiniones",
            "Plazos, entrega y errores administrativos frecuentes",
        ]),
